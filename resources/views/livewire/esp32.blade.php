<div>
    ...
    <a href="https://www.material-tailwind.com/magic-ai" target="_blank" class="ml-2">Generated with <b>Magic AI
            Blocks</b></a> by <a href="https://www.creative-tim.com/" target="_blank">Creative Tim</a>. <br /> <br />
    ...
    <section class="px-8 py-24">
        <div class="container mx-auto text-center">
            ...
            <p
                ...
                Check out our affordable pricing options for delicious meals.</p>
        </div>
        <div class="mt-24">
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div
                    ...
                    <div
                        ...
                        <p
                            ...
                            Enjoy a daily meal with our basic plan.</p>
                        <h3
                            class="antialiased tracking-normal font-sans text-3xl font-semibold leading-snug text-blue-gray-900 flex gap-1 mt-4">
                            $9.99<span
                    ...
                    <div class="p-6 border-t border-blue-gray-50">
                        <ul class="flex flex-col gap-3">
                            <li class="flex items-center gap-3 text-gray-700"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    aria-hidden="true" class="h-4 w-4 text-blue-gray-900">
                ...
                <div
                    ...
                    <div
                        ...
                        <p
                            class="block antialiased font-sans text-sm leading-normal text-inherit font-normal !text-gray-500">
                            A feast for the whole family to enjoy together.</p>
                        <h3
                            class="antialiased tracking-normal font-sans text-3xl font-semibold leading-snug text-blue-gray-900 flex gap-1 mt-4">
                            $29.99<span
                                class="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-blue-gray-900 -translate-y-0.5 self-end opacity-70"></span>
                ...
                <div
                    ...
                    <div
                        ...
                        <p
                            class="block antialiased font-sans text-sm leading-normal text-inherit font-normal !text-gray-500">
                            Customized menu options for your special occasions.</p>
                        <h3
                            class="antialiased tracking-normal font-sans text-3xl font-semibold leading-snug text-blue-gray-900 flex gap-1 mt-4">
